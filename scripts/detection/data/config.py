...
example_base_dataset = dataset_base.copy({
    'name': 'Example Dataset',

    'train_images': '/home/martin/catkin_ws/src/yolact_ros/scripts/yolact/datasets/output_dataset/images/train',
    'valid_images': '/home/martin/catkin_ws/src/yolact_ros/scripts/yolact/datasets/output_dataset/images/test',
    
    'train_info': '/home/martin/catkin_ws/src/yolact_ros/scripts/yolact/datasets/output_dataset/annotations/train.json',
    'valid_info': '/home/martin/catkin_ws/src/yolact_ros/scripts/yolact/datasets/output_dataset/annotations/test.json',
    
    'has_gt': True,

    'class_names': ("Hammer", "Pliers", "Crossheaded_Screwdriver", "Flat_Screwdriver", "Wrench"),
...
example_base_config = yolact_base_config.copy({
    'name': 'example_base',

    # Dataset stuff
    'dataset': example_base_dataset,
    'num_classes': len(example_base_dataset.class_names) + 1,
